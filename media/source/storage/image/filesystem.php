...
namespace Components;
  ...
  class Media_Storage_Image_Filesystem implements Media_Storage
  {
    ...
    /**
     * (non-PHPdoc)
     * @see Media_Storage::findByScheme()
     */
    ...
    /**
     * (non-PHPdoc)
     * @see Media_Storage::createByScheme()
     */
    ...
    /**
     * (non-PHPdoc)
     * @see Media_Storage::copyCategory()
     */
